 ...
 */
    ...
    use yii\helpers\Url;
    $paymentUrl = Yii::$app->urlManager->createAbsoluteUrl(['payment/external-payment', 'id_client' => base64_encode($client->id), "id_quote" => base64_encode($order->id)]);
?>

<center style="width: 100%; background-color: #FFF; color: #000">
