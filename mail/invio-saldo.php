...
<style>
    ...
    <div class="text" style="padding: 0 3em; color: #4d4d4d">
        <p>
            Le ricordiamo di effettuare il saldo delle sue bomboniere in vista della loro consegna. <br />
            Grazie di aver scelto orci del Cilento <br />
            Qui di seguito troverà il link per effettuare il relativo pagamento
        </p>
        <p>
