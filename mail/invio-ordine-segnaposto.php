...
?>
    ...
    <div class="text" style="padding: 0 3em; color: #4d4d4d">
        <p>
            le confermiamo che l'ordine segnaposto #<?= $model->id ?> del <?= $model->formatDate($model->created_at) ?> è stato preso in carico e che i segnaposto saranno pronti entro il giorno concordato <br />
